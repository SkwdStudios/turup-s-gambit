  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="scroll-bg p-8 rounded-lg">
            ...
            <div className="prose prose-lg dark:prose-invert">
              ...
              <p>
                ...
                between battles, using the game to sharpen their minds for the strategic challenges of warfare.
              </p>
              <p>
                Now, in the digital age, we bring this ancient game to you, preserving its rich history while enhancing
                it with the magic of modern technology.
              </p>
            </div>
          </div>

          <div className="scroll-bg p-8 rounded-lg">
            <h2 className="text-3xl font-medieval text-secondary mb-6">How To Play</h2>
            <div className="prose prose-lg dark:prose-invert">
              <p>
                Court Piece is a trick-taking card game played with a standard deck of 52 cards. The game is typically
                played by four players in fixed partnerships, with partners sitting opposite each other.
              </p>
              <p>
                The objective is to win a predetermined number of hands (usually 7 out of 13) before your opponents. The
                game combines elements of strategy, memory, and a bit of luck.
              </p>
              <p>
                Our digital version offers two modes: Classic (traditional rules) and Frenzy (a faster-paced variant
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-medieval text-primary text-center mb-12">The Royal Court</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <Card key={index} className="border-2 border-primary/30 bg-card/80 backdrop-blur-sm overflow-hidden">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-medieval text-secondary mb-1">{member.name}</h3>
