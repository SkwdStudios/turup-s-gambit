          ...
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start mb-12">
            <div className="relative">
              <Avatar className="w-32 h-32 border-4 border-primary">
                ...
                <AvatarFallback className="text-4xl font-medieval">{user.username.charAt(0)}</AvatarFallback>
              </Avatar>
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-4xl font-medieval text-primary mb-2">{user.username}</h1>
              <p className="text-muted-foreground mb-4">{user.email}</p>

              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                <div className="bg-card/50 backdrop-blur-sm p-3 rounded-lg border border-border/50">
                  <p className="text-sm text-muted-foreground">Games</p>
                  <p className="text-2xl font-medieval">{user.stats.gamesPlayed}</p>
                </div>
                <div className="bg-card/50 backdrop-blur-sm p-3 rounded-lg border border-border/50">
                  <p className="text-sm text-muted-foreground">Win Rate</p>
                  <p className="text-2xl font-medieval">{user.stats.winRate}</p>
                </div>
                <div className="bg-card/50 backdrop-blur-sm p-3 rounded-lg border border-border/50">
                  <p className="text-sm text-muted-foreground">High Score</p>
                  <p className="text-2xl font-medieval">{user.stats.highestScore}</p>
                </div>
              </div>

              <Button className="medieval-button" onClick={() => setIsEditing(!isEditing)}>
            ...
            <Card className="border-2 border-primary/30 bg-card/90 backdrop-blur-sm mb-12">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="avatar" type="file" className="medieval-input" accept="image/*" />
                </div>
              </CardContent>
              <CardFooter>
                <Button
            ...
            <Tabs defaultValue="history" className="mb-12">
              ...
              <TabsContent value="history">
                <Card className="border-2 border-primary/30 bg-card/90 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="font-medieval">Recent Games</CardTitle>
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-border/50">
                            <th className="text-left py-3 px-4 font-medieval">Date</th>
                            <th className="text-left py-3 px-4 font-medieval">Mode</th>
                            <th className="text-left py-3 px-4 font-medieval">Result</th>
                            <th className="text-left py-3 px-4 font-medieval">Score</th>
                          </tr>
                        </thead>
                        <tbody>
                          {user.gameHistory.map((game) => (
                            <tr key={game.id} className="border-b border-border/50">
                              ...
                              <td className="py-3 px-4 capitalize">{game.mode}</td>
              ...
              <TabsContent value="achievements">
                <Card className="border-2 border-primary/30 bg-card/90 backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="font-medieval">Your Achievements</CardTitle>
                    <CardDescription>Badges and honors earned in battle</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                      <div className="flex flex-col items-center text-center p-4 bg-card/50 rounded-lg border border-border/50">
                        <div className="w-16 h-16 mb-3 relative">
                          <Image src="/assets/achievement-1.png" alt="First Victory" fill className="object-contain" />
                        </div>
                        <h3 className="font-medieval text-secondary">First Victory</h3>
                        <p className="text-xs text-muted-foreground mt-1">Win your first game</p>
                      </div>
                      ...
                      <div className="flex flex-col items-center text-center p-4 bg-card/50 rounded-lg border border-border/50">
                        ...
                        <h3 className="font-medieval text-secondary">Master Strategist</h3>
                        <p className="text-xs text-muted-foreground mt-1">Win 50 games</p>
                      </div>

                      <div className="flex flex-col items-center text-center p-4 bg-card/50 rounded-lg border border-border/50">
                        <div className="w-16 h-16 mb-3 relative">
                          <Image src="/assets/achievement-3.png" alt="Perfect Game" fill className="object-contain" />
                        </div>
                        <h3 className="font-medieval text-secondary">Perfect Game</h3>
                        <p className="text-xs text-muted-foreground mt-1">Win all tricks in a game</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
