...
import { Home, User, Info, LogIn, LogOut, Menu, X, Music } from "lucide-react"
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center">
              <Link href="/" className="flex items-center gap-2">
                <span className="text-2xl font-medieval text-primary">Court Piece</span>
              </Link>
            </div>
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              >
                <Home size={18} className="transition-transform duration-300 hover:scale-110" />
                <span>Home</span>
              </Button>
              <Button
                variant="link"
            ...
            <Sheet>
              ...
              <SheetContent className="bg-card/95 backdrop-blur-md border-primary/20">
